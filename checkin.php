			...
			<header id="header">
				...
				<nav class="right">
					<?php
						...
						{
							//已經登入
							if ($_COOKIE['Ulogin']=="管理員"||$_COOKIE['Ulogin']=="class0" || $_COOKIE['Ulogin']=='管理員2')
											...
											while ($A_rowres = mysqli_fetch_array($A_result_status, MYSQLI_BOTH))
											{
												...
												<tr>
													...
													<td style="background-color:<?php echo $Color?>"><?php echo $A_rowres[3]?></td>
														<td style="background-color:<?php echo $Color?>"><?php echo $A_rowres[5]."(".$A_rowres[7].")"?></td>
												...
												<!--
														...
														<td style="background-color:<?php echo $Color?>"><?php echo $B_rowres[3]?></td>
