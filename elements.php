			...
			<header id="header">
				...
				<nav class="right">
					<?php
						...
						{
							//已經登入
							if($_COOKIE['Ulogin']=="管理員" || $_COOKIE['Ulogin']=='管理員2' || $_COOKIE['Ulogin']=="書審")
										...
										<?php
											while ($DATA_rowres = mysqli_fetch_array($DATA_result_status, MYSQLI_BOTH))
											{
												...
												<tr>
													...
													<td rowspan="4" style="background-color:<?php echo $Color?>"><?php echo $DATA_rowres[0]."<br>".$DATA_rowres[3]."<br>".$DATA_rowres[5]."(".$DATA_rowres[7].")"."<br>".$DATA_rowres[6]?></td>

												<?php
													if($DATA_rowres[8]=="1")
													{
												?>
												<td style="background-color:<?php echo $Color?>"><font color = "brown"><?php echo "軟體設計與應用<br>"?></font><?php echo $DATA_rowres[9] ?></td>
												...
												<?php
													...
													{
												?>
												<td style="background-color:<?php echo $Color?>"><font color = "brown"><?php echo "嵌入式系統與應用<br>"?></font><?php echo $DATA_rowres[9] ?></td>
												...
												<td style="background-color:<?php echo $Color?>"><font color = "brown"><?php echo "網路通訊與應用<br>"?></font><?php echo $DATA_rowres[9] ?></td>
												...
												<?php
													...
													<tr>
														<td style="background-color:<?php echo $Color?>"><font color="brown">假設您現在已經取得資訊工程學位，您想利用資訊科技來改善甚麼?怎麼做?<br></font><?php echo $DATA_rowres[10]?></td>
														<?php
															if($_COOKIE['Ulogin']=='管理員' || $_COOKIE['Uname']=='joechen')
															{
														?>
													...
													<tr>
														<td style="background-color:<?php echo $Color?>"><font color="brown">最近令您印象深刻的資訊科技相關新聞是甚麼?為甚麼?<br></font><?php echo $DATA_rowres[11] ?></td>
														<?php
													...
													<tr>
														<td style="background-color:<?php echo $Color?>"><font color="brown">您認為就讀資訊工程的學生，需要具備怎麼樣的能力或特質呢?<br></font><?php echo $DATA_rowres[12] ?></td>
														<?php
															if($_COOKIE['Ulogin']=='管理員')
															{
														?>
